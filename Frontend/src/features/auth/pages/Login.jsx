...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!result?.success) {
            setError(result?.message || "Unable to sign you in. Please try again.");
            return;
        }
                ...
                <div className='auth-content'>
                    <div className='auth-card'>
                        ...
                        <div className='auth-header'>
                            ...
                            <p className='auth-subtitle'>Enter your details to manage your projects.</p>
                        </div>
                    ...
                    <div className='auth-copyright'>
                        <p>© 2024 InterviewPro LABS INC. ALL RIGHTS RESERVED.</p>
                    </div>
                </div>
            </div>
        </div>
